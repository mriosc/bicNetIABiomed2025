...
"""
Verifique los genes descubiertos en el script anterior para ver si los cambios de grado de enfermedad a normal 
son de la misma manera (es decir, aumentan o disminuyen) que sus respectivos genes de élite. 
Conservar los genes similares para la validación final.
"""
...
#ruta_salida = r"C:/Users/marcr/OneDrive/Escritorio/IABioMed/Biclusters UniBic/GSE64763/6_final_biomarkers"

# Aurelio
ruta_grados_normal = r"/home/principalpc/git-repositories/bicNetIABiomed2025/Biclustering/GSE64763/5_degree/normal/FC_1/grados_todos_genes_bicluster.csv"
ruta_grados_tumor = r"/home/principalpc/git-repositories/bicNetIABiomed2025/Biclustering/GSE64763/5_degree/tumor/FC_1/grados_mapping_bicluster_tumor.csv"
ruta_elite = r"/home/principalpc/git-repositories/bicNetIABiomed2025/Biclustering/GSE64763/3_Filtrados_elite/genes_elite.txt"
ruta_salida = r"/home/principalpc/git-repositories/bicNetIABiomed2025/Biclustering/GSE64763/6_final_biomarkers"
...
if resultados:
    ...
    print("No se encontraron biomarcadores con cambio coherente.")
