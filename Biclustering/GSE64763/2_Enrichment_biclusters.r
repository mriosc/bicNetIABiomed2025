...
setwd("C:/Users/marcr/OneDrive/Escritorio/IABioMed/Biclusters UniBic/GSE64763")

# Leer el CSV
biclusters <- read.csv("3_Filtrados_elite/FC_1/FC1_normal_DEGs_symbols_deduplicated_biclusters_elite.csv", stringsAsFactors = FALSE)
