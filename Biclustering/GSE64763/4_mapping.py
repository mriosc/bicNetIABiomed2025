...
archivo_genes_elite = "C:/Users/marcr/OneDrive/Escritorio/IABioMed/Biclusters UniBic/GSE64763/5_degree/normal/FC_1/genes_mismo_grado_elite.csv"

# Ruta ABSOLUTA al archivo de biclusters tumorales
archivo_biclusters_tumor = "C:/Users/marcr/OneDrive/Escritorio/IABioMed/Biclusters UniBic/GSE64763/2_biclusters/FC_1/FC1_tumor_DEGs_symbols_deduplicated_biclusters.csv"

# Ruta de salida
ruta_salida = "C:/Users/marcr/OneDrive/Escritorio/IABioMed/Biclusters UniBic/GSE64763/5_degree/tumor/FC_1"
...
elite_genes = set(elite_df["attr_name"].dropna().str.strip().str.upper())
